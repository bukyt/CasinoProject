...
The system uses a shared Kafka topic for all financial transactions to ensure a centralized audit trail in the Ledger
service.
...
The Ledger service uses polymorphic JSON deserialization. Producers must ensure the `__TypeId__` header matches one of
